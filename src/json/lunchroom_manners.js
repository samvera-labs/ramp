...
export default {
  ...
  metadata: [
    {
      label: { en: ["Title"] },
      value: { en: ["Beginning Reponsibility: Lunchroom Manners [motion picture] Coronet Films"] }
    },
    {
      label: { en: ["Date"] },
      value: { en: ["1959"] }
    },
    {
      ...
      value: { en: ["Coronet Films"] }
    },
    {
      label: { en: ["Summary"] },
      value: { en: ["The rude, clumsy puppet <i>Mr. Bungle</i> shows kids how to behave in the school cafeteria - the assumption being that kids actually want to behave during lunch.\n\nThis film has a cult following since it appeared on a Pee Wee Herman HBO special."] }
    },
    {
      label: { en: ["Publishers"] },
      value: { en: ["Coronet Films"] }
    ...
    {
      label: { en: ["Subjects"] },
      value: { en: ["Social engineering", "Puppet theater"] }
    },
    {
      label: { en: ["Collection"] },
      value: { en: ["<a href=\"https://media.dlib.indiana.edu/collections/7h149q00t\">Sample Videos</a>"] }
    },
    {
      label: { en: ["Unit"] },
      value: { en: ["<a href=\"https://media.dlib.indiana.edu/collections?filter=Indiana+University+Libraries\">Indiana University Libraries</a>"] }
    },
    {
      label: { en: ["Languages"] },
      value: { en: ["English"] }
    ...
    },
    {
      ...
      value: {
        none: ["Videorecording Identifier: VA2038",
          "Issue Number: 77"]
      }
    }
  ],
