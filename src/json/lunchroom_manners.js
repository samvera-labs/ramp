export default {
  ...
  id:
    'https://dlib.indiana.edu/iiif_av/lunchroom_manners/lunchroom_manners.json',
  type: 'Manifest',
  label: {
    en: [
      ...
      items: [
        {
          ...
          items: [
            {
              id:
                'https://dlib.indiana.edu/iiif_av/lunchroom_manners/range/1-1',
              type: 'Range',
              label: { en: ['Washing Hands'] },
              items: [
                {
                  id:
                    'https://dlib.indiana.edu/iiif_av/lunchroom_manners/range/1-1-1',
                  type: 'Range',
                  label: { en: ['Using Soap'] },
                  items: [
                    {
                      id:
                        'https://dlib.indiana.edu/iiif_av/lunchroom_manners/canvas/1#t=157,160',
                      type: 'Canvas',
                    },
                  ],
                },
                {
                  id:
                    'https://dlib.indiana.edu/iiif_av/lunchroom_manners/range/1-1-2',
                  type: 'Range',
                  label: '',
                  items: [
                    {
                      id:
                        'https://dlib.indiana.edu/iiif_av/lunchroom_manners/canvas/1#t=160,165',
                      type: 'Canvas',
                    },
                  ],
                },
                {
                  id:
                    'https://dlib.indiana.edu/iiif_av/lunchroom_manners/range/1-1-3',
                  type: 'Range',
        ...
        },
        {
          ...
          items: [
            {
              id:
                'https://dlib.indiana.edu/iiif_av/lunchroom_manners/range/2-1',
              type: 'Range',
              label: { en: ['At the Counter'] },
              items: [
                {
                  id:
                    'https://dlib.indiana.edu/iiif_av/lunchroom_manners/range/2-1-1',
                  type: 'Range',
                  label: { en: ['Getting Tray'] },
                  items: [
                    {
                      id:
                        'https://dlib.indiana.edu/iiif_av/lunchroom_manners/canvas/1#t=227,245',
                      type: 'Canvas',
                    },
                  ],
                },
                {
                  id:
                    'https://dlib.indiana.edu/iiif_av/lunchroom_manners/range/2-1-2',
                  type: 'Range',
                  label: { en: ['Choosing Food'] },
                  items: [
                    {
                      id:
                        'https://dlib.indiana.edu/iiif_av/lunchroom_manners/canvas/1#t=258,288',
                      type: 'Canvas',
                    },
                  ],
                },
                {
                  id:
                    'https://dlib.indiana.edu/iiif_av/lunchroom_manners/range/2-1-3',
                  type: 'Range',
                  label: { en: ['There will be Cake'] },
                  items: [
                    {
                      id:
                        'https://dlib.indiana.edu/iiif_av/lunchroom_manners/canvas/1#t=301,308',
                      type: 'Canvas',
                    },
                  ],
                },
            ...
            {
              id:
                'https://dlib.indiana.edu/iiif_av/lunchroom_manners/range/2-2',
              type: 'Range',
              label: { en: ['At the Table'] },
              items: [
                {
                  id:
                    'https://dlib.indiana.edu/iiif_av/lunchroom_manners/range/2-2-1',
                  type: 'Range',
                  label: { en: ['Sitting Quietly'] },
                  items: [
                    {
                      id:
                        'https://dlib.indiana.edu/iiif_av/lunchroom_manners/canvas/1#t=323,333',
                      type: 'Canvas',
                    },
                  ],
                },
                {
                  id:
                    'https://dlib.indiana.edu/iiif_av/lunchroom_manners/range/2-2-2',
                  type: 'Range',
                  label: { en: ['Eating Neatly'] },
                  items: [
                    {
                      id:
                        'https://dlib.indiana.edu/iiif_av/lunchroom_manners/canvas/1#t=362,378',
                      type: 'Canvas',
                    },
                  ],
                },
            ...
            {
              id:
                'https://dlib.indiana.edu/iiif_av/lunchroom_manners/range/2-3',
              type: 'Range',
              label: { en: ['Leavning the Lunchroom'] },
              items: [
                {
                  id:
                    'https://dlib.indiana.edu/iiif_av/lunchroom_manners/range/2-3-1',
                  type: 'Range',
                  label: { en: ['Cleaning Up'] },
                  items: [
                    {
                      id:
                        'https://dlib.indiana.edu/iiif_av/lunchroom_manners/canvas/1#t=448,492',
                      type: 'Canvas',
                    },
                  ],
                },
                {
                  id:
                    'https://dlib.indiana.edu/iiif_av/lunchroom_manners/range/2-3-2',
                  type: 'Range',
                  label: { en: ['Putting Things Away'] },
                  items: [
                    {
                      id:
                        'https://dlib.indiana.edu/iiif_av/lunchroom_manners/canvas/1#t=511,527',
                      type: 'Canvas',
                    },
                  ],
                },
