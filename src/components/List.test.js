...
describe('ListItem component', () => {
  beforeEach(()=>{
    const listProps = { items: manifest.structures, isChild: true }
    const ListWithManifest = withManifestAndPlayerProvider(
      List, { initialManifestState: { manifest, canvasIndex: 0 }, ...listProps });
