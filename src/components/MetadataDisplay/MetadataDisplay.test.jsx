...
import manifestWoMetadata from '../../test_data/volleyball-for-boys';
import manifestWoCanvases from '../../test_data/empty-playlist';
import noRightsManifest from '../../test_data/transcript-annotation';
