...
/**
 * @returns {Function} VideoJSTitleLink class
 */
export const createVideoJSTitleLink = () => {
   ...
   */
  class VideoJSTitleLink extends Component {
...
let VideoJSTitleLink;
// Only register if videojs is available
if (typeof videojs !== 'undefined' && videojs.getComponent) {
  try {
    VideoJSTitleLink = createVideoJSTitleLink();
    videojs.registerComponent('VideoJSTitleLink', VideoJSTitleLink);
  } catch (e) {
    console.warn('Failed to register VideoJSTitleLink component:', e);
  }
}
