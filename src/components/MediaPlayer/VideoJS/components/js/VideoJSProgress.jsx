...
/**
 * @returns {Object} Object containing both CustomSeekBar and VideoJSProgress classes
 */
export const createVideoJSProgressComponents = () => {
  ...
  // Register custom seekbar component to be used in VideoJSProgress
...
if (typeof videojs !== 'undefined' && videojs.getComponent) {
  try {
    VideoJSProgress = createVideoJSProgressComponents();
    videojs.registerComponent('VideoJSProgress', VideoJSProgress);
  } catch (e) {
    console.warn('Failed to register VideoJSProgress component:', e);
  }
}
