...
/** SVG icon for multi-range structure timespans in StructuredNavigation */
export const MultiRangeSVGIcon = () => {
  return (
    <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" strokeWidth="2"
      strokeLinecap="round" strokeLinejoin="round" style={{ height: '0.75rem', width: '0.75rem' }}
      className="structure-item-cross-canvas"
    >
