            ...
            items: [
                {
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            metadata: [
                                {
                                    label: { en: ['The first metadata label for range 1-1'] },
                                    value: { en: ['The first metadata value for range 1-1'] },
                                },
                                {
                                    label: { en: ['The second metadata label for range 1-1'] },
                                    value: { en: ['The second metadata value for range 1-1'] },
                                },
                            ],
                            items: [
                                {
                                    ...
                                    metadata: [
                                        {
                                            label: { en: ['The metadata label for range 1-1-1'] },
                                            value: { en: ['The metadata value for range 1-1-1'] },
                                        },
                                    ],
                                    items: [
                                        {
