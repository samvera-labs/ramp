...
var TanscriptSelector = function TanscriptSelector(props) {
  var _React$useState = React.useState(props.title),
      _React$useState2 = slicedToArray(_React$useState, 2),
  ...
  if (props.transcriptData) {
    ...
    }))), /*#__PURE__*/React.createElement(TranscriptDownloader, {
      fileUrl: props.url,
...
function getAnnotationPage(_ref) {
  ...
  var annotations = parseAnnotations(parseManifest(manifest).getSequences()[0].getCanvases()[canvasIndex].__jsonld.annotations);
