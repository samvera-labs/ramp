const a = "播放", i = "暫停", e = "總共時間", r = "直播", o = "載入完畢", c = "進度", l = "全螢幕", d = "靜音", t = "開啟音效", u = "字幕", s = "內嵌字幕", p = "章節", g = "描述", y = "關閉", h = "重播", m = "文字", w = "白", b = "黑", f = "紅", S = "綠", P = "藍", k = "黃", T = "紫紅", C = "青", B = "背景", D = "視窗", R = "透明", v = "不透明", E = "無", M = "浮雕", x = "壓低", F = "均勻", W = "輕便的", V = "手寫體", A = "重置", L = "完成", N = "顏色", n = "不透明度", O = {
  Play: "播放",
  Pause: "暫停",
  "Current Time": "目前時間",
  Duration: e,
