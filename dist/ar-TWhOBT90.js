const e = "تشغيل", o = "إيقاف", t = "المدة", s = "مباشر", n = "تم التحميل", a = "التقدم", i = "ملء الشاشة", N = "كتم", r = "إلغاء الكتم", c = "الترجمة", l = "التسمية التوضيحية", d = "الفصول", p = "أغلق", u = "إعادة التشغيل", g = "الوصف", f = "النص", S = "أبيض", m = "أسود", y = "أحمر", w = "أخضر", b = "أزرق", h = "أصفر", P = "أرجواني", k = "أزرق سماوي", T = "الخلفية", C = "نافذة", v = "شفاف", M = "معتم", D = "لا شيء", E = "بارز", B = "منخفض", x = "منتظم", R = "Casual", F = "Script", A = "إعادة الضبط", W = "تم", V = "اللون", L = "معدل الشفافية", O = {
  Play: e,
  Pause: o,
