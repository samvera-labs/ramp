const i = "播放", r = "暂停", c = "时长", l = "直播", e = "加载完成", d = "进度", u = "全屏", p = "静音", o = "开启音效", g = "字幕", t = "内嵌字幕", s = "节目段落", w = "描述", h = "关闭", n = "重新播放", m = "文字", y = "白", b = "黑", f = "红", S = "绿", k = "蓝", P = "黄", T = "紫红", C = "青", D = "背景", B = "窗口", E = "透明", v = "不透明", R = "无", M = "浮雕", x = "压低", F = "均匀", V = "下阴影", W = "舒适", A = "手写体", L = "重置", N = "完成", O = "颜色", a = "不透明度", U = {
  Play: "播放",
  Pause: "暂停",
  "Current Time": "当前时间",
  Duration: "时长",
