      ...
      return regenerator.wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (function (t) { return Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require(t)); }); })("../../../../node_modules/video.js/dist/lang/".concat(langKey, ".json"));
          case 3:
...
var TranscriptSelector = function TranscriptSelector(_ref) {
  ...
  if (transcriptData) {
    ...
    if (isMachineGen) {
      result.push( /*#__PURE__*/React__default["default"].createElement("p", {
        key: "machine-gen-msg",
