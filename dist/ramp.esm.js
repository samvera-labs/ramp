...
function parseMetadata(metadata, resourceType) {
  ...
  if (metadata && (metadata === null || metadata === void 0 ? void 0 : metadata.length) > 0) {
    metadata.map(function (md) {
      ...
      var sanitizedValue = sanitizeHtml(value, _objectSpread$9({}, HTML_SANITIZE_CONFIG));
      parsedMetadata.push({
...
var useAnnotations = function useAnnotations(_ref9) {
   ...
   */
  var checkCanvas = useCallback(function () {
    if (!isCurrentCanvas) {
...
var ListItem = function ListItem(_ref) {
  ...
  var subMenu = items && items.length > 0 && !isSectionHeading ? /*#__PURE__*/React.createElement(List, {
    items: items,
    sectionRef: sectionRef,
    structureContainerRef: structureContainerRef
  }) : null;
  ...
  */
  ...
  if (label != '') {
    return /*#__PURE__*/React.createElement("li", {
      ...
      ref: liRef,
      role: "listitem",
      className: cx('ramp--structured-nav__list-item', isSectionHeading ? 'section-list-item' : '', isActiveLi ? 'active' : ''),
      "data-label": label,
...
var AnnotationLayerSelect = function AnnotationLayerSelect(_ref) {
  ...
  }, selectedAnnotationLayers.length > 0 ? "".concat(selectedAnnotationLayers.length, " of ").concat(annotationLayers.length, " layers selected") : "Select Annotation layer(s)", /*#__PURE__*/React.createElement("span", {
  ...
  (annotationLayers === null || annotationLayers === void 0 ? void 0 : annotationLayers.length) > 1 && /*#__PURE__*/React.createElement("li", {
    key: "select-all",
...
var AnnotationRow = function AnnotationRow(_ref) {
  ...
  if (canDisplay) {
    ...
    }, start != undefined && /*#__PURE__*/React.createElement("span", {
      className: "ramp--annotations__annotation-start-time",
      "data-testid": "annotation-start-time"
    }, timeToHHmmss(start, true)), end != undefined && /*#__PURE__*/React.createElement("span", {
      className: "ramp--annotations__annotation-end-time",
      "data-testid": "annotation-end-time"
    }, " - ".concat(timeToHHmmss(end, true)))), /*#__PURE__*/React.createElement("div", {
      key: "tags_".concat(id),
...
var AnnotationsDisplay = function AnnotationsDisplay(_ref) {
  ...
  if ((canvasAnnotationLayers === null || canvasAnnotationLayers === void 0 ? void 0 : canvasAnnotationLayers.length) > 0) {
    return /*#__PURE__*/React.createElement("div", {
    ...
    }, /*#__PURE__*/React.createElement("label", null, "Annotation layers: "), /*#__PURE__*/React.createElement(AnnotationLayerSelect, {
      ...
      tabIndex: 0
    }, hasDisplayAnnotations ? displayedAnnotations != undefined && (displayedAnnotations === null || displayedAnnotations === void 0 ? void 0 : displayedAnnotations.length) > 0 && /*#__PURE__*/React.createElement("ul", null, displayedAnnotations.map(function (annotation, index) {
      return /*#__PURE__*/React.createElement(AnnotationRow, {
        key: index,
        annotation: annotation,
        displayMotivations: displayMotivations
      });
    })) : /*#__PURE__*/React.createElement("p", null, "No Annotations with ".concat(displayMotivations.join('/'), " motivation."))));
  }
};
...
var MarkersDisplay = function MarkersDisplay(_ref) {
  ...
  }, /*#__PURE__*/React.createElement("h4", null, headingText)), isPlaylist ? /*#__PURE__*/React.createElement(React.Fragment, null, createMarker, markersTable) : /*#__PURE__*/React.createElement(AnnotationsDisplay, {
