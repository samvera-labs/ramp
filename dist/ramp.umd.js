(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('manifesto.js'), require('mime-db'), require('sanitize-html'), require('video.js'), require('videojs-hotkeys'), require('react-dom'), require('mammoth')) :
	typeof define === 'function' && define.amd ? define(['exports', 'react', 'manifesto.js', 'mime-db', 'sanitize-html', 'video.js', 'videojs-hotkeys', 'react-dom', 'mammoth'], factory) :
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.nulibAdminUIComponents = {}, global.React, global.manifesto, global.mimeDb, global.sanitizeHtml, global.videojs, null, global.ReactDOM, global.mammoth));
})(this, (function (exports, React, manifesto_js, mimeDb, sanitizeHtml, videojs, videojsHotkeys, ReactDOM, mammoth) { 'use strict';
	...
	var ListItem = function ListItem(_ref) {
	  ...
	  var _React$useState = React__default["default"].useState(getItemId(item)),
	    ...
	    _React$useState2[1];
	  var _React$useState3 = React__default["default"].useState(getLabelValue(item.label)),
	    _React$useState4 = _slicedToArray(_React$useState3, 2),
	    itemLabel = _React$useState4[0];
	    _React$useState4[1];
	  var childCanvases = getChildCanvases({
	    rangeId: item.id,
	    manifest: manifest
	...
	var Transcript = function Transcript(_ref) {
	  ...
	  var autoScrollAndHighlight = function autoScrollAndHighlight(currentTime, start, end, tr) {
	    ...
	    transcriptContainerRef.current.scrollTop = textTopOffset - transcriptContainerRef.current.clientHeight / 2;
	  };
	...
	var SupplementalFiles = function SupplementalFiles(_ref) {
	  ...
	  }))), Array.isArray(canvasSupplementalFiles) && canvasSupplementalFiles.length > 0 && /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/React__default["default"].createElement("h4", null, sectionHeading), canvasSupplementalFiles.map(function (canvasFiles, idx) {
	...
	var MarkersDisplay = function MarkersDisplay(_ref) {
	  ...
	  if (playlistMarkers.length > 0) {
	    ...
	    }, /*#__PURE__*/React__default["default"].createElement("h4", null, headingText)), /*#__PURE__*/React__default["default"].createElement("table", null, /*#__PURE__*/React__default["default"].createElement("thead", null, /*#__PURE__*/React__default["default"].createElement("tr", null, /*#__PURE__*/React__default["default"].createElement("th", null, "Name"), /*#__PURE__*/React__default["default"].createElement("th", null, "Time"), /*#__PURE__*/React__default["default"].createElement("th", null, "Actions"))), /*#__PURE__*/React__default["default"].createElement("tbody", null, playlistMarkers.map(function (marker, index) {
	...
	var MarkerRow = function MarkerRow(_ref2) {
	  ...
	  var _React$useState7 = React__default["default"].useState(marker.value),
	    _React$useState8 = _slicedToArray(_React$useState7, 2),
	    markerLabel = _React$useState8[0],
	    setMarkerLabel = _React$useState8[1];
	  var _React$useState9 = React__default["default"].useState(marker.timeStr),
	    _React$useState10 = _slicedToArray(_React$useState9, 2),
	    markerTime = _React$useState10[0],
	    setMarkerTime = _React$useState10[1];
	  var _React$useState11 = React__default["default"].useState(marker.time),
	    _React$useState12 = _slicedToArray(_React$useState11, 2),
	  ...
	  var _React$useState17 = React__default["default"].useState(false),
	    _React$useState18 = _slicedToArray(_React$useState17, 2),
	  ...
	  if (editing) {
	    return /*#__PURE__*/React__default["default"].createElement("tr", null, /*#__PURE__*/React__default["default"].createElement("td", null, /*#__PURE__*/React__default["default"].createElement("input", {
	      ...
	      name: "time"
	    })), /*#__PURE__*/React__default["default"].createElement("td", null, /*#__PURE__*/React__default["default"].createElement("button", {
	      type: "submit",
	    ...
	    }, markerLabel)), /*#__PURE__*/React__default["default"].createElement("td", null, markerTime), /*#__PURE__*/React__default["default"].createElement("td", null, /*#__PURE__*/React__default["default"].createElement("div", {
	    ...
	    return /*#__PURE__*/React__default["default"].createElement("tr", null, /*#__PURE__*/React__default["default"].createElement("td", null, /*#__PURE__*/React__default["default"].createElement("a", {
	      ...
	      "data-offset": markerOffset
	    }, markerLabel)), /*#__PURE__*/React__default["default"].createElement("td", null, markerTime), /*#__PURE__*/React__default["default"].createElement("td", null, /*#__PURE__*/React__default["default"].createElement("button", {
	      onClick: handleEdit,
	      className: "ramp--edit-button",
