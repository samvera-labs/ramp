(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('manifesto.js'), require('mime-db'), require('sanitize-html'), require('react-error-boundary'), require('classnames'), require('video.js'), require('mammoth')) :
	typeof define === 'function' && define.amd ? define(['exports', 'react', 'manifesto.js', 'mime-db', 'sanitize-html', 'react-error-boundary', 'classnames', 'video.js', 'mammoth'], factory) :
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.nulibAdminUIComponents = {}, global.React, global.manifesto, global.mimeDb, global.sanitizeHtml, global.reactErrorBoundary, global.cx, global.videojs, global.mammoth));
})(this, (function (exports, React, manifesto_js, mimeDb, sanitizeHtml, reactErrorBoundary, cx, videojs, mammoth) { 'use strict';
