(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('video.js'), require('videojs-hotkeys'), require('manifesto.js'), require('mime-db'), require('react-dom'), require('mammoth')) :
	typeof define === 'function' && define.amd ? define(['exports', 'react', 'video.js', 'videojs-hotkeys', 'manifesto.js', 'mime-db', 'react-dom', 'mammoth'], factory) :
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.nulibAdminUIComponents = {}, global.React, global.videojs, null, global.manifesto, global.mimeDb, global.ReactDOM, global.mammoth));
})(this, (function (exports, React, videojs, videojsHotkeys, manifesto_js, mimeDb, ReactDOM, mammoth) { 'use strict';
	...
	function PlayerReducer() {
	  ...
	  switch (action.type) {
	    ...
	    case 'setPlayerRange':
	      {
	        return _objectSpread$3(_objectSpread$3({}, state), {}, {
	          playerRange: _objectSpread$3(_objectSpread$3({}, state.playerRange), {}, {
	            start: action.start,
	            end: action.end
	          })
	        });
	...
	function getMediaInfo(_ref3) {
	  ...
	  if (mediaInfo.error) {
	    ...
	    return _objectSpread$2(_objectSpread$2({}, mediaInfo), {}, {
	      error: null,
	      mediaType: mediaType
	    });
	  }
	...
	function ProgressBar(_ref) {
	  ...
	  return /*#__PURE__*/React__default["default"].createElement("div", {
	    ...
	    ref: timeToolRef
	  }, timeToHHmmss(currentTime)), tLeft.length > 0 ? createRange(tLeft) : /*#__PURE__*/React__default["default"].createElement("div", {
	...
	function Downloader(_ref) {
	  ...
	  if (files && files.length > 0) {
	    ...
	    }, /*#__PURE__*/React__default["default"].createElement(VideoJSDownloadIcon, {
	      width: "1rem"
	...
	var TanscriptSelector = function TanscriptSelector(props) {
	  ...
	  if (props.transcriptData) {
	    ...
	    }))), props.noTranscript != 'no-transcript' && /*#__PURE__*/React__default["default"].createElement(TranscriptDownloader, {
	      fileUrl: props.url,
	      ...
	      if (annotations.length > 0) {
	        ...
	        if (type === 'TextualBody') {
	          ...
	          annotations.forEach(function (annotation) {
	            ...
	            supplementingItems.forEach(function (si, index) {
	...
	var Transcript = function Transcript(_ref) {
	  ...
	  if (!isLoading) {
	    ...
	    return /*#__PURE__*/React__default["default"].createElement("div", {
	      ...
	      noTranscript: (_timedText$ = timedText[0]) === null || _timedText$ === void 0 ? void 0 : _timedText$.key
	    })), /*#__PURE__*/React__default["default"].createElement("div", {
