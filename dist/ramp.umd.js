(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('video.js'), require('videojs-hotkeys'), require('manifesto.js'), require('mime-db'), require('sanitize-html'), require('react-dom'), require('mammoth')) :
	typeof define === 'function' && define.amd ? define(['exports', 'react', 'video.js', 'videojs-hotkeys', 'manifesto.js', 'mime-db', 'sanitize-html', 'react-dom', 'mammoth'], factory) :
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.nulibAdminUIComponents = {}, global.React, global.videojs, null, global.manifesto, global.mimeDb, global.sanitizeHtml, global.ReactDOM, global.mammoth));
})(this, (function (exports, React, videojs, videojsHotkeys, manifesto_js, mimeDb, sanitizeHtml, ReactDOM, mammoth) { 'use strict';
	...
	exports.SupplmentalFiles = SupplementalFiles;
