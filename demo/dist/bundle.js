...
(function (React, ReactDOM, manifesto_js, mammoth) {
	'use strict';
	    ...
	    case 'updateManifest':
	      {
	        return _objectSpread$1(_objectSpread$1({}, state), {}, {
	          manifest: _objectSpread$1({}, action.manifest)
	        });
	      }
	...
	function PlayerReducer() {
	  ...
	  switch (action.type) {
	    ...
	    case 'setPlayerRange':
	      {
	        return _objectSpread(_objectSpread({}, state), {}, {
	          playerRange: _objectSpread(_objectSpread({}, state.playerRange), {}, {
	            start: action.start,
	            end: action.end
	          })
	        });
	...
	*/
	...
	function _parseTranscriptData() {
	  _parseTranscriptData = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(url, canvasIndex) {
	    var tData, tUrl, fileType, fileData, type, jsonData, manifest, textData, textLines, isWebVTT;
	      ...
	      while (1) {
	        switch (_context.prev = _context.next) {
	          ...
	          case 22:
	            ...
	            _context.t1 = type;
	            _context.next = _context.t1 === 'application/json' ? 26 : _context.t1 === 'text/vtt' ? 36 : _context.t1 === 'text/plain' ? 36 : _context.t1 === 'application/msword' ? 49 : _context.t1 === 'application/vnd.openxmlformats-officedocument.wordprocessingml.document' ? 49 : 53;
	            break;
	...
	function _parseWordFile() {
	  _parseWordFile = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2(response) {
	...
	function _parseExternalAnnotations() {
	  _parseExternalAnnotations = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee3(annotation) {
	...
	function getAnnotations(_ref) {
	  ...
	  if (annotationPage) {
	    annotations = parseAnnotations(annotationPage.__jsonld.annotations, 'supplementing');
	  }
	...
	function parseWebVTTLine(_ref2) {
	...
	var css_248z$2 = "@import url(\"https://fonts.googleapis.com/css2?family=Open+Sans:wght@300;400;700&display=swap\");\n.irmp--structured-nav {\n  margin-top: 20px; }\n  .irmp--structured-nav a {\n    color: #7e7e7e;\n    transition: 0.25s; }\n    .irmp--structured-nav a:hover {\n      color: #bbbbbb; }\n  .irmp--structured-nav p {\n    padding-top: 1em;\n    color: #333333; }\n\nul.irmp--structured-nav__list {\n  list-style: none;\n  padding: 0 0 0 10px;\n  margin: 0px; }\n  ul.irmp--structured-nav__list li {\n    display: block;\n    padding: 0.25rem 0.5rem; }\n  ul.irmp--structured-nav__list li.active > a {\n    color: #000; }\n  ul.irmp--structured-nav__list li.active .tracker {\n    width: 0;\n    height: 0;\n    border-top: 3px solid transparent;\n    border-left: 7px solid #333333;\n    border-bottom: 3px solid transparent;\n    display: inline-block;\n    margin-left: -1em;\n    margin-right: 0.5em; }\n  ul.irmp--structured-nav__list span.irmp--structured-nav__section-title {\n    color: #333333; }\n\n.video-js .vjs-play-progress:before {\n  z-index: 101; }\n";
	...
	var TanscriptSelector = function TanscriptSelector(props) {
	  ...
	  if (props.transcriptData) {
	    ...
	    }))), /*#__PURE__*/React__default["default"].createElement(TranscriptDownloader, {
	      fileUrl: props.url,
	...
	var css_248z$1 = "@import url(\"https://fonts.googleapis.com/css2?family=Open+Sans:wght@300;400;700&display=swap\");\n.irmp--transcript_nav {\n  max-height: 30em;\n  font-size: 0.85em;\n  padding: 10px; }\n  .irmp--transcript_nav div.active {\n    background-color: #d3d3d3; }\n  .irmp--transcript_nav div.transcript_content {\n    height: 25em;\n    overflow-y: auto; }\n    .irmp--transcript_nav div.transcript_content p {\n      font-size: small;\n      color: #333333; }\n    .irmp--transcript_nav div.transcript_content #no-transcript {\n      font-size: medium;\n      padding: 2em; }\n  .irmp--transcript_nav div.transcript_content.static {\n    overflow-y: unset; }\n  .irmp--transcript_nav div.transcript_menu {\n    position: sticky;\n    top: 0; }\n  .irmp--transcript_nav iframe.transcript_viewer {\n    width: 100%;\n    width: -moz-available;\n    /* WebKit-based browsers will ignore this. */\n    width: -webkit-fill-available;\n    /* Mozilla-based browsers will ignore this. */\n    width: fill-available;\n    height: 25em;\n    /* Parent div's height - 5*/ }\n\ndiv.irmp--transcript_item {\n  display: flex;\n  margin: 10px 10px 10px 10px;\n  cursor: pointer; }\n  div.irmp--transcript_item:hover {\n    background-color: #cfd8d3;\n    transition: background-color 0.2s ease-in; }\n  div.irmp--transcript_item .irmp--transcript_time {\n    margin-right: 15px; }\n    div.irmp--transcript_item .irmp--transcript_time a {\n      text-decoration: none;\n      color: #477076; }\n      div.irmp--transcript_item .irmp--transcript_time a .disabled {\n        cursor: default; }\n  div.irmp--transcript_item .irmp--transcript_text {\n    color: black; }\n  div.irmp--transcript_item span::after {\n    display: block;\n    content: attr(title);\n    font-weight: bold;\n    height: 1px;\n    color: transparent;\n    overflow: hidden;\n    visibility: hidden; }\n\n/* TranscriptSelector styling */\n.irmp--transcript_selector {\n  margin-bottom: 20px;\n  background-color: #fff;\n  border: 1px solid transparent;\n  padding: 1em;\n  border-color: #d3d3d3;\n  border-radius: 3px;\n  position: relative; }\n  .irmp--transcript_selector select {\n    font-family: \"Open Sans\", sans-serif;\n    padding: 4px;\n    width: 100%; }\n  .irmp--transcript_selector .selector-content {\n    margin: 0;\n    position: absolute;\n    width: 50%; }\n\n@media only screen and (min-width: 992px) {\n  .irmp--transcript_selector > div > select {\n    max-width: 100%; } }\n\n/* TranscriptDownloader styling */\nbutton.irmp--transcript_downloader {\n  float: right;\n  margin: 0;\n  position: relative;\n  color: #000;\n  border-radius: 3px;\n  text-align: center;\n  line-height: 20px;\n  border: 1px solid #d3d3d3;\n  width: fit-content; }\n\n/* Extra small devices (600px and down) */\n@media only screen and (max-width: 600px) {\n  .irmp--transcript_selector {\n    min-height: 4em; }\n    .irmp--transcript_selector select {\n      min-width: 8em; }\n  button.irmp--transcript_downloader .download-label:after {\n    content: 'Download'; } }\n\n/* Small devices (600px and up) */\n@media only screen and (min-width: 600px) {\n  .irmp--transcript_selector {\n    min-height: 3.5em;\n    padding: 0.5em; }\n  button.irmp--transcript_downloader .download-label:after {\n    content: 'Download this transcript'; } }\n";
	...
	var Transcript = function Transcript(_ref) {
	  ...
	  var setStateVar = /*#__PURE__*/function () {
	    var _ref2 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(transcript) {
	      var title, url;
	      return regenerator.wrap(function _callee$(_context) {
	        while (1) {
	          switch (_context.prev = _context.next) {
	...
	function App(_ref) {
	  ...
	  return /*#__PURE__*/React__default["default"].createElement(ManifestProvider, null, /*#__PURE__*/React__default["default"].createElement(PlayerProvider, null, /*#__PURE__*/React__default["default"].createElement(IIIFPlayerWrapper, {
	    ...
	    manifest: manifest
	  }, children), /*#__PURE__*/React__default["default"].createElement(StructuredNavigation, null), /*#__PURE__*/React__default["default"].createElement(Transcript, {
	...
	var id = "https://samvera-labs.github.io/iiif-react-media-player/manifests/mahler-symphony-3.json";
	var type = "Manifest";
	var label = {
		en: [
			"Symphony no. 3 - Mahler, Gustav, 1860-1911"
		]
	};
	var description = "Published by the Indiana University School of Music. Recorded Jan. 17-18, 1995, in the Musical Arts Center, Bloomington, Ind. Compact disc";
	var start = {
		id: "https://samvera-labs.github.io/iiif-react-media-player/manifests/mahler-symphony-3.json",
		type: "SpecificResource",
		source: "https://samvera-labs.github.io/iiif-react-media-player/manifests/mahler-symphony-3/canvas/2",
		selector: {
			type: "PointSelector",
			t: 120.5
		}
	...
	var items = [
		{
			id: "https://samvera-labs.github.io/iiif-react-media-player/manifests/mahler-symphony-3/canvas/1",
			type: "Canvas",
			duration: 1985,
			items: [
				{
					id: "https://samvera-labs.github.io/iiif-react-media-player/manifests/mahler-symphony-3/annopage/1",
					type: "AnnotationPage",
					items: [
						{
							id: "https://samvera-labs.github.io/iiif-react-media-player/manifests/mahler-symphony-3/annopage/1/1",
							type: "Annotation",
							motivation: "painting",
							target: "/manifests/mahler-symphony-3/canvas/1",
							body: [
								{
									type: "Choice",
									choiceHint: "user",
									items: [
										{
											id: "https://samvera-labs.github.io/iiif-react-media-player/mahler-symphony-3/CD1/320Kbps.mp4",
											type: "Audio",
										...
										{
											id: "https://samvera-labs.github.io/iiif-react-media-player/mahler-symphony-3/CD1/128Kbps.mp4",
											type: "Audio",
											format: "audio/mp4; codec..xxxxx",
											label: {
												en: [
		...
		{
			id: "https://samvera-labs.github.io/iiif-react-media-player/manifests/mahler-symphony-3/canvas/2",
			type: "Canvas",
			duration: 3829,
			items: [
				{
					id: "https://samvera-labs.github.io/iiif-react-media-player/manifests/mahler-symphony-3/annopage/2",
					type: "AnnotationPage",
					items: [
						{
							id: "https://samvera-labs.github.io/iiif-react-media-player/manifests/mahler-symphony-3/annopage/2/2",
							type: "Annotation",
							motivation: "painting",
							target: "/manifests/mahler-symphony-3/canvas/2",
							body: [
								{
									type: "Choice",
									choiceHint: "user",
									items: [
										{
											id: "https://samvera-labs.github.io/iiif-react-media-player/mahler-symphony-3/CD2/320Kbps.mp4",
											type: "Audio",
											format: "audio/mp4; codec..xxxxx",
											label: {
												en: [
										...
										{
											id: "https://samvera-labs.github.io/iiif-react-media-player/mahler-symphony-3/CD2/128Kbps.mp4",
											type: "Audio",
											format: "audio/mp4; codec..xxxxx",
											label: {
												en: [
	...
	var structures = [
		{
			id: "https://samvera-labs.github.io/iiif-react-media-player/manifests/mahler-symphony-3/range/0",
			type: "Range",
			behavior: "no-nav",
			label: {
				en: [
			...
			items: [
				{
					id: "https://samvera-labs.github.io/iiif-react-media-player/manifests/mahler-symphony-3/range/1",
					type: "Range",
					label: {
						en: [
					...
					items: [
						{
							id: "https://samvera-labs.github.io/iiif-react-media-player/manifests/mahler-symphony-3/range/1-1",
							type: "Range",
							label: {
								en: [
									"Intro"
							...
							items: [
								{
									id: "https://samvera-labs.github.io/iiif-react-media-player/manifests/mahler-symphony-3/range/1-1-1",
									type: "Range",
									label: {
										en: [
											"Track 1. I. Kraftig"
									...
									items: [
										{
											id: "https://samvera-labs.github.io/iiif-react-media-player/manifests/mahler-symphony-3/canvas/1#t=0,374",
											type: "Canvas"
										}
									]
								}
						...
						{
							id: "https://samvera-labs.github.io/iiif-react-media-player/manifests/mahler-symphony-3/range/1-3",
							type: "Range",
							label: {
								en: [
									"Track 3. Tempo I"
							...
							items: [
								{
									id: "https://samvera-labs.github.io/iiif-react-media-player/manifests/mahler-symphony-3/canvas/1#t=525,711",
									type: "Canvas"
								}
							]
						},
						{
							id: "https://samvera-labs.github.io/iiif-react-media-player/manifests/mahler-symphony-3/range/1-4",
							type: "Range",
							label: {
								en: [
									"Track 4. Schwungvoll"
							...
							items: [
								{
									id: "https://samvera-labs.github.io/iiif-react-media-player/manifests/mahler-symphony-3/canvas/1#t=711,1188",
									type: "Canvas"
								}
							]
						},
						{
							id: "https://samvera-labs.github.io/iiif-react-media-player/manifests/mahler-symphony-3/range/1-5",
							type: "Range",
							label: {
								en: [
									"Track 5. Immer dasselbe Tempo"
								]
							},
							items: [
								{
									id: "https://samvera-labs.github.io/iiif-react-media-player/manifests/mahler-symphony-3/canvas/1#t=1188,1406",
									type: "Canvas"
								}
							]
						},
						{
							id: "https://samvera-labs.github.io/iiif-react-media-player/manifests/mahler-symphony-3/range/1-6",
							type: "Range",
							label: {
								en: [
									"Track 6. Wie zu Anfang"
								]
							},
							items: [
								{
									id: "https://samvera-labs.github.io/iiif-react-media-player/manifests/mahler-symphony-3/canvas/1#t=1406,1693",
									type: "Canvas"
								}
							]
						},
						{
							id: "https://samvera-labs.github.io/iiif-react-media-player/manifests/mahler-symphony-3/range/1-7",
							type: "Range",
							label: {
								en: [
									"Track 7. Tempo I"
							...
							items: [
								{
									id: "https://samvera-labs.github.io/iiif-react-media-player/manifests/mahler-symphony-3/canvas/1#t=01693,1985",
									type: "Canvas"
								}
							]
						}
				...
				{
					id: "https://samvera-labs.github.io/iiif-react-media-player/manifests/mahler-symphony-3/range/2",
					type: "Range",
					label: {
						en: [
							"CD2 - Mahler, Symphony No.3 (cont.)"
						]
					},
					items: [
						{
							id: "https://samvera-labs.github.io/iiif-react-media-player/manifests/mahler-symphony-3/range/2-1",
							type: "Range",
							label: {
								en: [
									"Track 1. II. Tempo di Menuetto"
								]
							},
							items: [
								{
									id: "https://samvera-labs.github.io/iiif-react-media-player/manifests/mahler-symphony-3/canvas/2#t=0,566",
									type: "Canvas"
								}
							]
						},
						{
							id: "https://samvera-labs.github.io/iiif-react-media-player/manifests/mahler-symphony-3/range/2-2",
							type: "Range",
							label: {
								en: [
									"Track 2. III. Comodo"
							...
							items: [
								{
									id: "https://samvera-labs.github.io/iiif-react-media-player/manifests/mahler-symphony-3/canvas/2#t=566,1183",
									type: "Canvas"
								}
							]
						},
						{
							id: "https://samvera-labs.github.io/iiif-react-media-player/manifests/mahler-symphony-3/range/2-3",
							type: "Range",
							label: {
								en: [
									"Track 3. Tempo I"
							...
							items: [
								{
									id: "https://samvera-labs.github.io/iiif-react-media-player/manifests/mahler-symphony-3/canvas/2#t=1183,1635",
									type: "Canvas"
								}
							]
						},
						{
							id: "https://samvera-labs.github.io/iiif-react-media-player/manifests/mahler-symphony-3/range/2-4",
							type: "Range",
							label: {
								en: [
									"Track 4. IV. Misterioso"
								]
							},
							items: [
								{
									id: "https://samvera-labs.github.io/iiif-react-media-player/manifests/mahler-symphony-3/canvas/2#t=1635,2204",
									type: "Canvas"
								}
							]
						},
						{
							id: "https://samvera-labs.github.io/iiif-react-media-player/manifests/mahler-symphony-3/range/2-5",
							type: "Range",
							label: {
								en: [
									"Track 5. V. Lustig im Tempo"
								]
							},
							items: [
								{
									id: "https://samvera-labs.github.io/iiif-react-media-player/manifests/mahler-symphony-3/canvas/2#t=2204,2475",
									type: "Canvas"
								}
							]
						},
						{
							id: "https://samvera-labs.github.io/iiif-react-media-player/manifests/mahler-symphony-3/range/2-6",
							type: "Range",
							label: {
								en: [
									"Track 6. VI. Langsam"
							...
							items: [
								{
									id: "https://samvera-labs.github.io/iiif-react-media-player/manifests/mahler-symphony-3/canvas/2#t=2475,3047",
									type: "Canvas"
								}
							]
						},
						{
							id: "https://samvera-labs.github.io/iiif-react-media-player/manifests/mahler-symphony-3/range/2-7",
							type: "Range",
							label: {
								en: [
									"Track 7. Nicht mehr so breit"
								]
							},
							items: [
								{
									id: "https://samvera-labs.github.io/iiif-react-media-player/manifests/mahler-symphony-3/canvas/2#t=3047,3287",
									type: "Canvas"
								}
							]
						},
						{
							id: "https://samvera-labs.github.io/iiif-react-media-player/manifests/mahler-symphony-3/range/2-8",
							type: "Range",
							label: {
								en: [
									"Track 8. Tempo I"
							...
							items: [
								{
									id: "https://samvera-labs.github.io/iiif-react-media-player/manifests/mahler-symphony-3/canvas/2#t=3287,3451",
									type: "Canvas"
								}
							]
						},
						{
							id: "https://samvera-labs.github.io/iiif-react-media-player/manifests/mahler-symphony-3/range/2-9",
							type: "Range",
							label: {
								en: [
									"Track 9. Tempo I"
							...
							items: [
								{
									id: "https://samvera-labs.github.io/iiif-react-media-player/manifests/mahler-symphony-3/canvas/2#t=3451,3829",
									type: "Canvas"
								}
							]
						}
	...
	console.log(config);
	var props = {
	  manifestUrl: "".concat(config.url, "/manifests/").concat(config.env, "/mahler-symphony-3.json"),
	  manifest: manifest
	};
	ReactDOM__default["default"].render( /*#__PURE__*/React__default["default"].createElement(App, props), document.getElementById('root'));

})(React, ReactDOM, manifesto, mammoth);
